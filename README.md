...
I found this article interesting as I frequently play the NYT Games and did not realize that implementing dark mode would be such a complicated task. At first, I would think the developers would just need to invert the colors of the background and make a few small changes to some of the colors. However, as many of their colors are tied to their brand, it is not as simple as this.
...
### Add Comments from Tuo (tz2714@nyu.edu)
I am Tuo, and I also enjoy reading this article. I really like the part when it mentions the system design of dark mode. The reason is their clear strategies. Firstly, they will think about "How does engineering come into play as designers are exploring?" at the beginning. Then, according to this idea, they will start to think of the process, including Alignment, Foundation, and Exploration.
